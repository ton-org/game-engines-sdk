/**
 * A copy from https://github.com/ton-community/gamefi-sdk/blob/ada116fa51861c2a137eecc119955bcab1c82c3d/src/content.ts
...
export function decodeImage(dc: DecodedContent): string | Buffer | undefined {
  ...
  if (
    dc.offchainFields !== undefined &&
    'image' in dc.offchainFields &&
    'image_data' in dc.offchainFields
  ) {
